...
// Prepare copies './testdata' folder for test to temp directory
// and returns you absolute path to this temp directory
//
...
func CompareFiles(a, b string) bool {
	...
	// read 'a'
	if aData, err = ioutil.ReadFile(a); err != nil {
		return false
	}

	// read 'b'
	if bData, err = ioutil.ReadFile(b); err != nil {
		return false
	}
